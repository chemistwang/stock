  ...
  return (
    <Card hoverable>
      <section className={styles.bg}>
        <div className={`${styles.loader} ${styles["loader-12"]}`}>
          <svg
          ...
          <svg
            className={`${styles["loader-star"]} ${styles.star4}`}
            version="1.1"
            xmlns="http://www.w3.org/2000/svg"
            // xmlns:xlink="http://www.w3.org/1999/xlink"
            x="0px"
          ...
          <svg
            className={`${styles["loader-star"]} ${styles.star5}`}
            version="1.1"
            xmlns="http://www.w3.org/2000/svg"
            // xmlns:xlink="http://www.w3.org/1999/xlink"
            x="0px"
          ...
          <svg
            className={`${styles["loader-star"]} ${styles.star6}`}
            version="1.1"
            xmlns="http://www.w3.org/2000/svg"
            // xmlns:xlink="http://www.w3.org/1999/xlink"
            x="0px"
